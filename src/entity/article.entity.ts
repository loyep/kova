...
export class Article extends BaseEntity {
   ...
   * 分类
   */
  @ManyToOne(() => Category, async (category: Category) => await category.articles)
   ...
   * 作者
   */
  @ManyToOne(() => User, async (user: User) => await user.articles)
   ...
   * 文章标签
   */
  @ManyToMany(() => Tag, async (tag: Tag) => await tag.articles)
  @JoinTable({
    name: 'article_tags',
   ...
   * 专题
   */
  @ManyToMany(() => Topic, async (topic: Topic) => await topic.articles)
  @JoinTable({
    name: 'article_topics',
    joinColumn: { name: 'article_id', referencedColumnName: 'id' },
   ...
   * 文章评论
   */
  @OneToMany(() => Comment, async (comment: Comment) => await comment.article)
  comments: Comment[]
   ...
   * 文章内容
   */
  @OneToOne(() => Content, async (content: Content) => await content.article)
  content: Content
